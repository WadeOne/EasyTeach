...
namespace EasyTeach.Core.Tests.Services.UserManagement.Impl
{
    public sealed class UserServiceTest
    {
        ...
        public UserServiceTest()
        {
            ...
            _dtoMapper = A.Fake<IDtoMapper>();
            _userService = new UserService(_userRepository, _dtoMapper);
        ...
        public void CreateUser_ValidStudentUser_UserCreated()
        {
            ...
            A.CallTo(() => _dtoMapper.Map(_validUser)).Returns(userDto);
            ...
            A.CallTo(() => _dtoMapper.Map(_validUser)).MustHaveHappened();
        }
        ...
        public void CreateUser_InvalidUser_InvalidUserExceptionThrownUserNotCreatedProperError()
        {
            var user = new User();
            var userDto = A.Fake<IUserDto>();
            A.CallTo(() => _dtoMapper.Map(user)).Returns(userDto);
            ...
            A.CallTo(() => _dtoMapper.Map(A<IUserModel>.Ignored)).MustNotHaveHappened();
        }
